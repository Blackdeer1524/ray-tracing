#include "color.h"
#include "hittable.h"
#include "lib/hittable_list/hittable_list.h"
#include "rtweekend.h"
#include "sphere.h"
#include "vec3.h"
...
int main() {
    ...
    const auto delta_u = viewport_width / image_width;
    const auto delta_v = -viewport_height / image_height;

    const point3 camera_center(0, 0, 0);
    point3 viewport_position = camera_center + vec3(0, 0, -focal_length);

    point3 p00_position = viewport_position - v_u / 2 - v_v / 2 +
